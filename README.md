...
- [x] [Postman](#postman)
- [x] [Documentation](#doc)
- [x] [Selected appropriate technology and language](#satal)
- [x] [Project description](#desc)
- [x] [Use of a common DB](#db)
- [x] [Comments in source code](#com)
- [x] [Use of cache](#cache)
- [x] [Use of messaging principle](#msg)
- [x] [Security and Authorisation implementation](#sec)
- [x] [Use of Interceptors](#inter)
- [x] [Use of the technologies](#tech)
- [x] [Deployment to a production server, e.g. Heroku](#deploy)
- [x] [Suitable architecture](#arch)
- [x] [Initialization procedure](#init)
- [x] [Used design patterns](#pat)
- [x] [Use Cases](#use)
- [x] [Cloud services](#cloud)
